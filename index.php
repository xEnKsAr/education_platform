        ...
        <div class="row min-vh-100 align-items-center">
            <div class="col-lg-6 mx-auto ">
                <div class="bg-light shadow text-muted py-5">
                    <h1 class="text-center mb-3">تسجيل الدخول</h1>
                    <div class="px-3">
                        <?= getFlashMessage('success'); ?>
                        <?= getFlashMessage('error'); ?>
                    </div>
                    <form method="POST" action="<?= base_url() . '/backend/student/login.php' ?>" class="rounded px-3 w-100">
                        <div class=" my-3">
                        ...
                        <div class="my-3">
                            <input type="submit" class="btn w-100 btn-success rounded-0" value="تسجيل الدخول" />
                        </div>
